import{_ as U,L as G,J as K,E as W}from"./preview.a7f47650.js";import{o as v,a as y,v as r,y as x,u as E}from"./vue.esm-bundler.09fbef75.js";import"./chunk-2GDW2BFM.eab564c8.js";import"./index.e850844b.js";import"./iframe.0ad70ec4.js";import"../sb-preview/runtime.js";const R={name:"CollectionFilter",presets:!0,docs:"https://help.ecomposer.io/docs/elements/collection-elements/filter/",mixins:[G,K,W],props:{data:{type:Object,default(){return{}}}},data(){return{jsreactives:["filter_type","show_all_items_menu","collapse_mobile"]}},computed:{listMenu(){var e,s,l,A,M,S,w,m;return`
                    <${((e=this.data.settings)==null?void 0:e.use_accordion)&&this.data.settings.filter_type!=="dropdown"&&((s=this.data.settings)==null?void 0:s.filter_type)!=="push_down"?"details":"div"}
                                ...
                                class="${this.data.settings&&this.data.settings.use_accordion&&this.data.settings.filter_type!=="dropdown"&&((A=this.data.settings)==null?void 0:A.filter_type)!=="push_down"?" ecom-collection__filters-group-not__dropdown":" ecom-collection__filters-group-dropdown"} ecom-collection__filters-group ecom-collection__filters-group-lists" data-attrs-max="${this.data.settings&&this.data.settings.number_max?this.data.settings.number_max:5}">
                        <summary class="ecom-collection__filters-group-summary">
                            <div class="ecom-collection__filters-group-header">
                                <span class="ecom-collection__filters-group-summary--title">${(S=(M=this.data.settings)==null?void 0:M.menu_label)!=null?S:""}</span>
                    ...
                    </${((w=this.data.settings)==null?void 0:w.use_accordion)&&this.data.settings.filter_type!=="dropdown"&&((m=this.data.settings)==null?void 0:m.filter_type)!=="push_down"?"details":"div"}>
                `},liquids(){var e,s,l,A,M,S,w,m,k,f,g,H,z,F,L,q,h,C,b,I,T,B,$,P,D,N,t,o,i,c,n,a;return{filters:{code:`
                        ...
                        {% endcapture %}
                        ${(s=(e=this.data)==null?void 0:e.settings)!=null&&s.show_applied_filters?`
                                {% if EComBuilderMode %}
                                ...
                                <div class="ecom-collection__filters-applied-block">
                                    ...
                                    <div class="ecom-collection-filters--active_values">
                                        <ul class="ecom-collection-filters--active_values-list" role="list">
                                            ...
                                            {% endfor %}
                                            <li class="ecom-collection__filters-group-list-item ecom-al_center">
                                                <a href="{{collection.url}}" title="${this.lang((l=this.data.settings)!=null&&l.clear_text?this.data.settings.clear_text:"Clear all","clear_all_title")}" class="ecom-collection__filters-group-list-item-clear">${this.lang((A=this.data.settings)!=null&&A.clear_text?this.data.settings.clear_text:"Clear all","clear_all_title")}{{close_icon}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                {%- endif -%}
                        `:""}
                        <div class="ecom-container-filter-list--wrapper ${((M=this.data.settings)==null?void 0:M.filter_type)=="push_down"?"ecom-show--filter":""}" ${((S=this.data.settings)==null?void 0:S.filter_type)=="push_down"?"data-type='push_down'":""}>
                            <div class="ecom-container-filter-list-wrapper">
                                ${((w=this.data.settings)==null?void 0:w.filter_type)==="push_down"?`<h3
                                            class="ecom-collection__filters-heading"
                                        >
                                        ${this.lang((m=this.data.settings)==null?void 0:m.title,"filter_title")}
                                        </h3>`:""}
                                <div class="ecom-container-filter-list" ${((k=this.data.settings)==null?void 0:k.filter_type)=="push_down"?"data-type='push_down'":""}>
                                    ${this.show_sub_menu?`<div class="ecom-shopify_menu" data-show-all="${(f=this.show_all_items_menu)!=null?f:!1}">${this.listMenu}</div>`:""}
                                {%- for filter in collection.filters -%}
                                    {%- assign total_active_values = total_active_values | plus: filter.active_values.size -%}
                                    {% case filter.type %}
                                    {% when 'list' %}
                                        {% assign size = filter.values | size %}
                                        {% assign settings_size = ${(g=this.data.settings)==null?void 0:g.number_max} %}
                                        {%- if size > 0 -%}
                                        <${((H=this.data.settings)==null?void 0:H.use_accordion)&&this.data.settings.filter_type!=="dropdown"&&((z=this.data.settings)==null?void 0:z.filter_type)!=="push_down"?"details":"div"}
                                        data-name="{{filter.param_name}}"
                                        ${(F=this.data.settings)!=null&&F.accordion_open?" open ":""}
                                        class="ecom-js-filter${this.data.settings&&this.data.settings.use_accordion&&this.data.settings.filter_type!=="dropdown"&&((L=this.data.settings)==null?void 0:L.filter_type)!=="push_down"?" ecom-collection__filters-group-not__dropdown":" ecom-collection__filters-group-dropdown"} ecom-collection__filters-group ecom-collection__filters-group-lists ecom-d-none" data-index="{{ forloop.index }}" data-attrs-max="${this.data.settings&&this.data.settings.number_max?this.data.settings.number_max:5}">
                                            ...
                                            <div class="ecom-collection__filters-group--display ${((q=this.data.settings)==null?void 0:q.filter_type)=="push_down"?"ecom-scroll_bar":""}">
                                                ${(h=this.data.settings)!=null&&h.show_selected?`
                                                    <div class="ecom-collection__filters-group--header">
                                                        <span class="ecom-collection__filters-group--selected no-js-hidden">
                                                            ...
                                                            {% if count == 1%}
                                                                ${this.lang((C=this.data.settings)==null?void 0:C.filter_selected_text,"filter_selected_text",{count:"count"})}
                                                            {% else %}
                                                                ${this.lang((b=this.data.settings)==null?void 0:b.filters_selected_text,"filters_selected_text",{count:"count"})}
                                                            {% endif %}
                                                        </span>
                                                        <a href="{{ filter.url_to_remove }}" class="ecom-collection__filters-group-reset-filter" >${this.lang((I=this.data.settings)==null?void 0:I.reset_filter,"reset_filter")}</a>
                                                    </div>`:""}
                                                ...
                                                {%- for value in filter.values -%}
                                                    ...
                                                    <li class="ecom-collection__filters-group-list-item ${this.dropdown_max?"ecom-collection__filters-group-list-item-max":""}${(T=this.data.settings)!=null&&T.hide_color_checkbox?" ecom-filter-hide-checkbox":""}" >
                                                        <label for="ecom-filter-{{ filter.label | escape  | strip }}-{{ forloop.index }}" class="ecom-collection__filters-group-checkbox{% if value.count == 0 and value.active == false %} ecom-collection__filters-group-checkbox--disabled{% endif %}">
                                                            ...
                                                            <span class="ecom-collection__filters-group-checkbox-label ecom-flex ecom-al_center${(B=this.data.settings)!=null&&B.color_show_count?" ecom-filter-hide-color-count":""}">
                                    ...
                                    {% when 'price_range' %}
                                        {% liquid
                                            ...
                                            <${this.data.settings.use_accordion&&this.data.settings.filter_type!=="dropdown"&&((D=this.data.settings)==null?void 0:D.filter_type)!=="push_down"?"details":"div"}
                                            ${(N=this.data.settings)!=null&&N.accordion_open?" open ":""}
                                            class="ecom-collection__filters-group ${this.data.settings.use_accordion&&this.data.settings.filter_type!=="dropdown"&&((t=this.data.settings)==null?void 0:t.filter_type)!=="push_down"?"ecom-collection__filters-group-not__dropdown":"ecom-collection__filters-group-dropdown"} ecom-collection__filters-group-price-range" data-index="{{ forloop.index }}">
                                                <summary class="ecom-collection__filters-group-summary">
                                                    <div class="ecom-collection__filters-group-header">
                                                        <span class="ecom-collection__filters-group-summary--title">{{ filter.label | escape }}</span>
                                                ...
                                                <div class="ecom-collection__filters-group--display ${((o=this.data.settings)==null?void 0:o.filter_type)=="push_down"?"ecom-scroll_bar":""}">
                                                    {%- comment -%}
                                                    ${(i=this.data.settings)!=null&&i.show_selected?`<div class="ecom-collection__filters-group--header">
                                                            {%- assign max_price_amount = filter.range_max | money -%}
                                                            <span class="ecom-collection__filters-group--selected">${this.lang((c=this.data.settings)==null?void 0:c.max_price_text,"max_price_text")} {{max_price_amount}}</span>
                                                            <a href="{{ filter.url_to_remove }}" class="ecom-collection__filters-group-reset-filter" >${this.lang((n=this.data.settings)==null?void 0:n.reset_filter,"reset_filter")}</a>
                                                        </div>`:""}
                                                    {%- endcomment -%}
                    ...
                    `,preview:""}}},settings(){return[{group_title:"General",params:[{type:"text",name:"title",label:"Filter title",value:"Filter by",options:{warnings:{content:"Notice: the filter only works in the collection page and after template's published"}}},{type:"popup",name:"filter_type",label:"Filter type",options:{default:!1,type:"dropdown",values:{block:"Block",collapse:"Collapse",dropdown:"Dropdown",push_down:"Push down"}},css:!1},{type:"number",name:"number_item_in_row",label:"Items per row",options:{responsive:!0,max:6,min:1,step:1,visible:function(e){return e.filter_type==="push_down"}},css:{selector:' .ecom-container-filter-list[data-type="push_down"]',properties:{"grid-template-columns":"repeat(%value%, 1fr)"}}},{type:"toggle",label:"Show applied filters",name:"show_applied_filters",options:{values:{on:{label:"Show",value:!0},off:{label:"Hide",value:!1}}},css:!1},{type:"text",name:"applied_title",label:"Applied Filter title",placeholder:"Applied filters",options:{visible:function(e){return e.show_applied_filters}}},{type:"line"},{name:"icon",type:"picker",label:"Open filter button Icon",options:{oneline:!0,type:"icon",reset:!1,output:["value","cate"],visible:{keep_data:!0,condition:e=>e.filter_type=="collapse"||e.collapse_mobile}}},{type:"toggle",label:"Enable Ajax filter",name:"enable_ajax",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},oneline:!0}},{type:"toggle",label:"Display as accordion",name:"use_accordion",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},visible:{keep_data:!1,condition:e=>e.filter_type!=="dropdown"&&e.filter_type!=="push_down"},oneline:!0}},{type:"toggle",label:"Accordion default open",name:"accordion_open",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},visible:function(e){return e.filter_type!=="dropdown"&&e.filter_type!=="push_down"&&e.use_accordion},oneline:!0}},{type:"toggle",label:"Show selected/reset",name:"show_selected",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},oneline:!0}},{type:"toggle",label:"Hide checkbox",name:"hide_checkbox",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},oneline:!0}},{type:"toggle",label:"Show number count",name:"show_count",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},visible:function(e){return e.filter_type!=="collapse"&&e.filter_type!=="dropdown"},oneline:!0}},{name:"dropdown_show",label:"Show option values",type:"popup",options:{values:{full:"Full",short:"Short"},type:"dropdown",visible:function(e){return e.filter_type=="dropdown"}},css:!1},{name:"number_max",label:"Maximum values to show",type:"number",options:{min:0,max:20,visible:function(e){return e.filter_type=="dropdown"&&e.dropdown_show=="short"}}},{name:"number_button",label:'Show button "more values"',type:"toggle",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},oneline:!0,visible:function(e){return e.filter_type=="dropdown"&&e.dropdown_show=="short"}},css:!1},{name:"button_text",label:"More values label",type:"text",options:{visible:function(e){return e.filter_type=="dropdown"&&e.dropdown_show=="short"&&e.number_button==!0}}},{type:"toggle",label:"Collapse on mobile and tablet",name:"collapse_mobile",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},visible:function(e){return e.filter_type!=="collapse"},oneline:!0}},{type:"toggle",label:"Hide zero count",name:"hide_zero",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},oneline:!0}},{type:"popup",label:"Content Aligntment",name:"items_alignment",value:"",options:{preview:"title",type:"dropdown",default:!1,icon_type:"alignment",values:{"inline-flex":"Horizontal",block:"Vertical"}},css:{selector:" .ecom-collection__filters-group-list ",properties:{display:""}}},{type:"line"},{type:"paragraph",content:`To setup your filtering you can going to **Online Store** > **Navigation** > **Collection and search filters**.
                            ...
                            **This element only work on collection page**
                            ...
                            `}]},{group_title:"Color filter",params:[{type:"toggle",label:"Show options as color",name:"show_color",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}}},css:!1},{type:"text",label:"",name:"option_name",placeholder:"Color",description:"Set your color [Here](#extensions)",options:{visible:function(e){return e.show_color}}},{type:"toggle",label:"Hide checkbox",name:"hide_color_checkbox",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},oneline:!0}},{type:"toggle",label:"Hide label",name:"hide_color_label",options:{values:{on:{label:"Yes",value:"0px"},off:{label:"No",value:"inherit"}},oneline:!0},css:{selector:" .ecom-collection__filters-enable-colors .ecom-collection__filters-group-checkbox-label",properties:{"font-size":""}}},{type:"toggle",label:"Hide number count",name:"color_show_count",options:{values:{on:{label:"Yes",value:!0},off:{label:"No",value:!1}},visible:function(e){return e.filter_type!=="collapse"&&e.filter_type!=="dropdown"},oneline:!0}},{type:"popup",label:"Content Aligntment",name:"items_color_alignment",value:"",options:{type:"dropdown",default:!1,icon_type:"alignment",values:{"inline-flex":"Horizontal",block:"Vertical"}},css:{selector:" .ecom-collection__filters-group-list.ecom-collection__filters-enable-colors",properties:{display:""}}}]},{group_title:"Change text",params:[{name:"filter_selected_text",label:"Filter selected",type:"text",options:{placeholder:"{{ count }} selected"}},{name:"filters_selected_text",label:"Filters selected",type:"text",options:{placeholder:"{{ count }} selected"}},{type:"text",name:"clear_text",label:"Clear filter",value:"Clear all"},{name:"reset_filter",label:"Filter reset",type:"text",options:{placeholder:"Reset"}},{type:"text",name:"max_price_text",label:"Max price",value:"Max price"}]},{group_title:"Menu",params:[{type:"toggle",label:"Show menu",name:"show_sub_menu",options:{values:{on:{label:"Show",value:!0},off:{label:"Hide",value:!1}}},css:!1},{type:"text",name:"menu_label",label:"Menu label",options:{visible:e=>e.show_sub_menu===!0}},{type:"toggle",label:"Show all item(by default)",name:"show_all_items_menu",options:{visible:e=>e.show_sub_menu===!0&&e.filter_type!=="dropdown"&&e.filter_type!=="push_down",values:{on:{label:"Show",value:!0},off:{label:"Hide",value:!1}}},css:!1},{type:"picker",name:"link_list",label:"Menu",options:{visible:e=>e.show_sub_menu===!0,type:"menu",layout:"list",multiple:!1}},{name:"tab",type:"tab",value:"normal",options:{visible:e=>e.show_sub_menu===!0,tabs:[{name:"normal",title:"Normal"},{name:"active",title:"Active"}]},css:{isCss:!1}},{type:"picker",label:"Icon",name:"icon_menu",options:{visible:e=>e.tab==="normal"&&e.show_sub_menu===!0,reset:!1,type:"icon",multiple:!1},css:{isCss:!1}},{type:"picker",label:"Icon",name:"icon_menu_active",options:{visible:e=>e.tab==="active"&&e.show_sub_menu===!0,reset:!1,type:"icon",multiple:!1},css:{isCss:!1}}]}]},link_list(){return this.data&&this.data.settings&&this.data.settings.link_list&&this.data.settings.link_list.value?this.data.settings.link_list.value:null},icon_menu(){var e,s;return(s=(e=this.data)==null?void 0:e.settings)==null?void 0:s.icon_menu},icon_menu_active(){var e,s;return(s=(e=this.data)==null?void 0:e.settings)==null?void 0:s.icon_menu_active},show_dropdown_arrow(){var e;return this.data.settings.filter_type==="dropdown"||((e=this.data.settings)==null?void 0:e.use_accordion)},show_count(){return!!(this.data.settings&&this.data.settings.show_count)},hide_zero(){return!!(this.data.settings&&this.data.settings.hide_zero)},dropdown_max(){return this.data.settings.filter_type==="dropdown"&&this.data.settings.number_max>=0},show_sub_menu(){var e,s;return(s=(e=this.data)==null?void 0:e.settings)==null?void 0:s.show_sub_menu},show_all_items_menu(){var e,s;return(s=(e=this.data)==null?void 0:e.settings)==null?void 0:s.show_all_items_menu},javascript(){return function(){let e=this.$el,s=this.isLive;if(!e)return;s||setTimeout(function(){e.closest(".ecom-block")&&(e.closest(".ecom-block").style.zIndex=2,e.style.zIndex=7)},500);const l=this;e.querySelectorAll(".ecom-collection__filters-group-list").forEach(t=>{t.childNodes.length&&t.closest(".ecom-collection__filters-group").classList.remove("ecom-d-none")});function M(){e.querySelector(".ecom-collection__filters-dropdown")&&e.querySelector(".ecom-collection__filters-dropdown").classList.add("ecom-filter-dropdown-desktop");let t=e.querySelectorAll(".ecom-filter-dropdown-desktop .ecom-collection__filters-group .ecom-collection__filters-group-summary");!t||t.forEach(o=>{let i=o.closest(".ecom-collection__filters-group"),c=i.dataset.attrsMax,n=i.querySelectorAll(".ecom-collection__filters-group-list-item-max"),a=i.querySelector(".ecom-more-filter");a&&a.addEventListener("click",()=>{S(n),a.style.display="none"}),n.length>0&&c&&(c=parseInt(c),S(n,c)),o.closest(".ecom-collection__filters-group").classList.contains("active")&&o.closest(".ecom-collection__filters-group").classList.remove("active"),o.addEventListener("click",()=>{let _=o.closest(".ecom-collection__filters-group");_.classList.contains("active")?_.classList.remove("active"):(t.forEach(d=>d.closest(".ecom-collection__filters-group").classList.contains("active")&&d.closest(".ecom-collection__filters-group").classList.remove("active")),_.classList.add("active"))})})}function S(t,o){t.forEach((i,c)=>{o===void 0||c<o?i.style.display="block":i.style.display="none"})}const w=this.settings.collapse_mobile;this.settings.filter_type=="dropdown"&&M();const m=e.querySelector("#ecom-modal-block"),k=e.querySelector("#button_menu_block"),f=m?m.closest("div.ecom-core.core__block"):"",g=m?m.closest("div.ecom-column.ecom-core"):"",H=e.querySelector("#ecom-modal-close"),z=window.matchMedia("only screen and (max-width: 911px)");z.addEventListener("change",q),w&&z.matches&&q(z);function F(){m.style.display="block",f&&(f.style.zIndex="99"),g&&(g.style.zIndex="99"),document.querySelector("body").classList.add("ecom-filter-opened")}function L(){m.style.display="none",f&&(f.style.zIndex="1"),g&&(g.style.zIndex="1"),document.querySelector("body").classList.remove("ecom-filter-opened")}function q(t){let o=e.querySelectorAll(".ecom-collection__filters-group--display");t.matches?l.settings.collapse_mobile&&m&&k&&H&&(m&&(m.style.display="none"),l.settings.filter_type=="dropdown"&&o.forEach(i=>{i.style.position="relative"}),k.addEventListener("click",()=>{F()}),H.addEventListener("click",()=>{L()}),window.addEventListener("click",()=>{event.target==m&&L()}),f&&(f.style.zIndex="99"),g&&(g.style.zIndex="99")):(m&&(m.style.display="block"),f&&(f.style.zIndex="1"),g&&(g.style.zIndex="1"),l.settings.filter_type=="dropdown"&&o&&o.forEach(i=>{i.style.position="absolute"}))}(this.settings.filter_type=="collapse"||this.settings.filter_type=="push_down"&&this.settings.collapse_mobile)&&(k.addEventListener("click",()=>{F()}),H.addEventListener("click",()=>{L()}),window.addEventListener("click",()=>{event.target==m&&L()}));let h=0,C=0,b=0,I=15;function T(t){h===0&&(t.style.maxHeight="100%"),h=t.offsetHeight,b=h,t.classList.remove("ecom-show--filter");var o=h/10;t.style.overflow="hidden",C=setInterval(function(){b-=o,b>0?t.style.maxHeight=b+"px":(t.style.maxHeight=0,clearInterval(C))},I)}function B(t){var o=h/10;t.classList.add("ecom-show--filter"),C=setInterval(function(){b+=o,b<h?t.style.maxHeight=b+"px":(t.style.maxHeight=h+"px",clearInterval(C))},I)}function $(){const t=e.querySelector('.ecom-container-filter-list--wrapper[data-type="push_down"]');t&&(T(t),t.style.display="none",t.style.opacity="1",k.addEventListener("click",()=>{t.classList.contains("ecom-show--filter")?T(t):(t.style.display="grid",B(t))}))}$();function P(){let t=1,o=15e3;if(!e.querySelector(".ecom-collection__filters-group-price"))return!0;let i=e.querySelector(".ecom-collection__filters-price-range-max"),c=e.querySelector(".ecom-collection__filters-price-range-min"),n=e.querySelector("#ecom-collection-filters--input-min"),a=e.querySelector("#ecom-collection-filters--input-max");t=parseFloat(c.getAttribute("min")),o=parseFloat(i.getAttribute("max"));function _(p){return window.EComposer.formatMoney(p)}function d(){let p=(o-t)*n.value/100+t,u=(o-t)*a.value/100+t;c.value=Math.floor(p),i.value=Math.floor(u),e.querySelector("#ecom-collection-filters--price-from").innerHTML=`${_(Math.floor(p*100))}`,e.querySelector("#ecom-collection-filters--price-to").innerHTML=`${_(Math.floor(u*100))}`}a.addEventListener("input",()=>{let p=parseInt(n.value),u=parseInt(a.value);u<p+10&&(n.value=u-10,p===parseInt(n.min)&&(a.value=10)),d()}),n.addEventListener("input",()=>{let p=parseInt(n.value),u=parseInt(a.value);p>u-10&&(a.value=p+10,u===parseInt(a.max)&&(n.value=parseInt(a.max)-10)),d()})}function D(){var t=e.querySelectorAll(".ecom-shopify__menu-item--has-children > .ecom-menu_item, .ecom-shopify__menu-child-link-item--has-children > .ecom-menu_item");if(!!t){var o,i="false",c=e.querySelector(".ecom-shopify_menu");if(c&&c.dataset.showAll)var i=c.dataset.showAll;for(o=0;o<t.length;o++){let n=function(a){let _=a.nextElementSibling,d=null;if(a.classList.contains("ecom-item-active")){if(a.classList.remove("ecom-item-active"),_){_.style.maxHeight=null;var p=_.querySelectorAll(".ecom-menu_item");p&&p.forEach(u=>{var j=u.nextElementSibling;j&&(j.style.maxHeight=null),u.classList.remove("ecom-item-active")}),d=a.closest(".ecom-shopify__menu-sub-menu"),d&&(d.style.maxHeight=parseInt(d.style.maxHeight)-_.scrollHeight+"px")}}else a.classList.add("ecom-item-active"),_&&(d=a.closest(".ecom-shopify__menu-sub-menu"),d&&(d.style.maxHeight=parseInt(d.style.maxHeight)+_.scrollHeight+"px"),_.style.maxHeight=_.scrollHeight+"px")};i&&i=="true"&&n(t[o]),t[o].addEventListener("click",function(a){a.preventDefault(),n(this)})}}}D();const N=function(){return{searchParamsInitial:window.location.search.slice(1),searchParamsPrev:window.location.search.slice(1),init(){const t=e.querySelectorAll(".ecom-collection__filters-form");if(t.length==0)return;const o=t[0].closest(".ecom-sections[data-section-id]"),i=t[0].closest(".ecom-row.ecom-section");!o||!o.dataset.sectionId||(this.facetForms=t,this.wrapper=o,this.sectionId=o.dataset.sectionId,this.wrapper_product=i,this.debouncedOnSubmit=this.debounce(c=>{this.onSubmitHandler(c)},100),this.facetForms.forEach(c=>c.addEventListener("input",this.debouncedOnSubmit.bind(this))),this.handleRemoveFilter(),this.setListeners())},setListeners(){const t=o=>{const i=o.state?o.state.searchParams:this.searchParamsInitial;if(i===this.searchParamsPrev)return;const c=`${window.location.pathname}?section_id=${this.sectionId}&${i}`;this.handleLoadProduct(c,i,o,!1)};window.addEventListener("popstate",t)},debounce(t,o){let i;return(...c)=>{clearTimeout(i),i=setTimeout(()=>t.apply(this,c),o)}},onSubmitHandler(t){t.preventDefault();const o=[];this.facetForms.forEach(a=>{o.push(this.createSearchParams(a))});const i=o.join("&"),c=`${window.location.pathname}?section_id=${this.sectionId}&${i}`;this.handleLoadProduct(c,i,t);let n=e.querySelector('.ecom-container-filter-list--wrapper[data-type="push_down"]');n&&T(n)},createSearchParams(t){const o=new FormData(t);return new URLSearchParams(o).toString()},handleLoadProduct(t,o,i,c=!0){const n=this;this.searchParamsPrev=o;const a=async function(_){return(await fetch(_,{method:"GET",headers:{"Content-Type":"text/html"}})).text()};n.wrapper_product.classList.add("ecom-doing-filter"),a(t).then(function(_){const d=document.createElement("div");d.innerHTML=_;const p=n.wrapper_product.querySelector(".ecom-collection__product-main.ecom-collection_product_template_collection");!p||(p.innerHTML=d.querySelector(".ecom-collection__product-main.ecom-collection_product_template_collection").innerHTML,c&&n.updateURLHash(o),n.renderFilters(d,i),n.renderActiveFacets(d),p.querySelector(".ecom-collection__product--wrapper-items")&&p.dispatchEvent(new CustomEvent("ecom-products-init",{detail:{wrapper:p}})))}).finally(function(){n.wrapper_product.classList.remove("ecom-doing-filter"),M()})},updateURLHash(t){history.pushState({searchParams:t},"",`${window.location.pathname}${t&&"?".concat(t)}`)},renderActiveFacets(t){const o=t.querySelector(".ecom-collection__filters-applied-block"),i=this.wrapper_product.querySelector(".ecom-collection__filters-applied-block"),c=this.wrapper_product.querySelectorAll(".ecom-collection__filter-values");!i&&o?this.facetForms.forEach(n=>{n.prepend(o)}):i&&o?i.innerHTML=o.innerHTML:i&&!o&&this.facetForms.forEach(n=>{n.querySelector(".ecom-collection__filters-applied-block")&&n.querySelector(".ecom-collection__filters-applied-block").remove()}),c.length>0&&c.forEach(n=>{o?n.innerHTML=o.querySelector(".ecom-collection-filters--active_values").innerHTML:n.innerHTML=""})},renderFilters(t,o){const i=t.querySelectorAll(".ecom-js-filter"),c=p=>{if(o.target===window)return!1;const u=o?o.target.closest(".ecom-js-filter"):void 0;return u?p.dataset.index===u.dataset.index:!1},n=Array.from(i),a=Array.from(i).find(c);n.forEach(p=>{this.wrapper_product.querySelector(`.ecom-js-filter[data-index="${p.dataset.index}"]`).innerHTML=p.innerHTML}),_(t,this.wrapper_product),a&&d(a,o.target.closest(".ecom-js-filter"));function _(p,u){const j=p.querySelector(".ecom-collection-filters--active_values-list"),V=u.querySelector(".ecom-collection-filters--active_values-list");!j||!V||(V.innerHTML=j.innerHTML)}function d(p,u){if(!u)return;const j=u.querySelector(".ecom-collection__filters-group--selected"),V=p.querySelector(".ecom-collection__filters-group--selected"),Y=u.querySelector(".ecom-collection__filters-group-summary"),O=p.querySelector(".ecom-collection__filters-group-summary");V&&j&&(u.querySelector(".ecom-collection__filters-group--selected").outerHTML=p.querySelector(".ecom-collection__filters-group--selected").outerHTML),Y&&O&&(u.querySelector(".ecom-collection__filters-group-summary").outerHTML=p.querySelector(".ecom-collection__filters-group-summary").outerHTML)}},handleRemoveFilter(){this.facetForms.forEach(o=>{o.addEventListener("click",t.bind(this))});function t(o){if(o.target.closest(".ecom-collection__filters-group-list-item-clear")||o.target.closest(".ecom-collection__filters-group-reset-filter")){o.preventDefault();const i=o.target.closest(".ecom-collection__filters-group-list-item-clear")||o.target.closest(".ecom-collection__filters-group-reset-filter");if(!i.href)return;const c=i.href.indexOf("?")==-1?"":i.href.slice(i.href.indexOf("?")+1),n=`${window.location.pathname}?section_id=${this.sectionId}&${c}`;this.handleLoadProduct(n,c,o)}}}}}();s&&(P(),this.settings.enable_ajax?N.init():this.$el.querySelector(".ecom-collection__filters-form").addEventListener("change",function(){this.submit()}))}},requestShopifyType(){return{shopify_type:"collection"}},css(){return`
